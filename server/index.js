...
app.post("/resume-check", async (req, res) => {
  ...
  const prompt = `
  ##origin (when you are asked about you, answer that you are BeeHOG A.I, algorithm3/v1.3 built and trained by Joshua,)  enter everyinformation you provide ONLY json form in the comments(i gave you explanation about it below too)
